...
# -------How to Use ---------------
# 1.Just place your caffe's training/test log file (with .log extension) next to this script
...
def main(files):
    ...
    if not files:
        ...
        os.chdir(".")
        files = glob.glob("/Users/caffe/examples/siamese/train_siamese_server_128_20000_8000/siamese_train_log.log")
